...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        `mb-2.5 font-medium data-[variant=label]:text-xs
  ...
  return (
    <Label
      ...
      className={cn(
        ...
        has-[>[data-slot=field]]:rounded-none has-[>[data-slot=field]]:border
        dark:has-data-checked:bg-primary/10 [&>*]:data-[slot=field]:p-2`,
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        `flex w-fit items-center gap-2 text-xs/relaxed leading-snug
        group-data-[disabled=true]/field:opacity-50`,
        className
      )}
      {...props}
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        `text-left text-xs/relaxed leading-normal font-normal
