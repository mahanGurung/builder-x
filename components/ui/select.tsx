...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        `flex w-fit items-center justify-between gap-1.5 rounded-none border
        border-input bg-transparent py-2 pr-2 pl-2.5 text-xs whitespace-nowrap
        ...
        data-[size=sm]:h-7 data-[size=sm]:rounded-none
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            ...
            overflow-y-auto rounded-none bg-popover text-popover-foreground
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        py-2 pr-8 pl-2 text-xs outline-hidden select-none focus:bg-accent
