    ...
    <ComboboxPrimitive.Portal>
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          data-chips={!!anchor}
          className={cn(
            `group/combobox-content relative max-h-(--available-height) max-h-72
            w-(--anchor-width) max-w-(--available-width) min-w-36
            min-w-[calc(var(--anchor-width)+--spacing(7))]
            origin-(--transform-origin) overflow-hidden rounded-none bg-popover
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        ...
        py-2 pr-8 pl-2 text-xs outline-hidden select-none
...
function ComboboxEmpty({ className, ...props }: ComboboxPrimitive.Empty.Props) {
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn(
        `hidden w-full justify-center py-2 text-center text-xs
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        `flex min-h-8 flex-wrap items-center gap-1 rounded-none border
        border-input bg-transparent bg-clip-padding px-2.5 py-1 text-xs
        ...
        has-aria-invalid:ring-1 has-aria-invalid:ring-destructive/20
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        ...
        rounded-none bg-muted px-1.5 text-xs font-medium whitespace-nowrap
