    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        className={cn(
          ...
          -translate-x-1/2 -translate-y-1/2 gap-4 rounded-none bg-background p-4
          ring-1 ring-foreground/10 duration-100 outline-none
          data-[size=default]:max-w-xs data-[size=sm]:max-w-xs
          data-[size=default]:sm:max-w-sm data-open:animate-in
...
function AlertDialogMedia({
  ...
  return (
    <div
      ...
      className={cn(
        `mb-2 inline-flex size-10 items-center justify-center rounded-none
